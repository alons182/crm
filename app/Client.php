...
class Client extends Model
{
	 ...
	 protected $fillable = ['ide','fullname', 'company', 'job', 'email', 'web', 'phone1','phone2','phone3','comments', 'address','referred','referred_others','image','status','income','debts','debts_amount','potencial','prima','formalization_date','reservation_date','option_date','expedient_date','credit','avaluo_date','documents','documents_text','fiador','fiador_text','project','bank','bank2','email2','cita','reservation_paid','cita_date'];
